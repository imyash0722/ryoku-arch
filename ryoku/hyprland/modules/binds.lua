...
hl.bind(K(mod .. " + Z"),          hl.dsp.exec_cmd(ws_helper .. " hide"))          -- hide the focused window in the scratchpad (press again on it to bring it back)
...
hl.bind(K(mod .. " + ALT + Z"),    hl.dsp.exec_cmd(ws_helper .. " scratch"))       -- show or hide the scratchpad (special workspace)
